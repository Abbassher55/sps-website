...
export default function StatsSection() {
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-[#003f83] to-[#001b3f] text-white">
      <div className="max-w-[1280px] mx-auto px-4 md:px-16 grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
        {stats.map((stat, idx) => (
